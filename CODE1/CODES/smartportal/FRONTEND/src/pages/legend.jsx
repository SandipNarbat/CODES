...
export default function InfoPopup({ title, content, path, onClose }) {
  ...
  useEffect(() => {
    if (isStandalone) {
      ...
      const handleBeforeUnload = () => {
        channel.postMessage({ type: 'TAB_CLOSED', path });
      };
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ marginTop: '1rem', marginBottom: '2rem', lineHeight: '1.5' }}>
          {content || (
            <p>
              This is a placeholder for the <strong>{title}</strong> explanation.<br/>
