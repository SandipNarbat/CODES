...
export default function CBSFlow({ onClose }) {
  ...
  useEffect(() => {
    if (isStandalone) {
      ...
      const handleBeforeUnload = () => {
        channel.postMessage({ type: 'TAB_CLOSED', path: '/cbs-flow' });
      };
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ marginTop: '1rem', marginBottom: '2rem', lineHeight: '1.5' }}>
            <p>
              This is a placeholder for the <strong>CBS Flow</strong> explanation.<br/>
